...
public class Productos_Tipo_Listado extends javax.swing.JFrame {

    public Productos_Tipo_Listado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (jTable_tipos.getColumnModel().getColumnCount() > 0) {
            ...
            jTable_tipos.getColumnModel().getColumn(1).setResizable(false);
            jTable_tipos.getColumnModel().getColumn(1).setPreferredWidth(400);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Productos_Tipo_Listado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
